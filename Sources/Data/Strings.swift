...
enum L10n {
    ...
    static let de: [String: String] = [
        ...
        "start.toc": "Original-Inhaltsverzeichnis",
        "start.toc.sub": "Alle Abschnitte mit Seitenzahl, wie 1899 gedruckt",
        ...
        "settings.preview": "Tritt ein Gast in das Local, so haben ihn die anwesenden Kellner stehend zu begrüßen.",
        ...
        "settings.reset": "Lesefortschritt zurücksetzen",
        "settings.reset.confirm": "Dein Lesefortschritt wird auf diesem Gerät gelöscht.",
    ...
    static let en: [String: String] = [
        ...
        "start.toc": "Original table of contents",
        "start.toc.sub": "All sections with page numbers, as printed in 1899",
        "start.tafeln": "Plates",
        "start.menus": "Menus",
        ...
        "settings.reset": "Reset reading progress",
        "settings.reset.confirm": "Your reading progress will be deleted on this device.",
